...
export class PromotionService {
    ...
    get(promotionType: string, page: number, count: number): Observable<PagingResponse<Promotion>> {
        return this.http.get(this.api + '?promotionType=' + promotionType + '&pageNumber=' + page + '&itemsCount=' + count);
    }
